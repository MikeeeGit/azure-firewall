...
The test uses mocked providers and makes no Azure changes. Add the layer to the private firewall component's reviewed saved-plan inputs before installing the controller or mounting its certificate.
